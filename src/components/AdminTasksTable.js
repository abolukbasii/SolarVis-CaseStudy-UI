...
const AdminTasksTable = (props) => {
    const {tasks, isLoading, handleDelete, showEditModal, users} = props;
    const columns = [
        {
            title: 'Created At',
        ...
        },
        {
          ...
          onFilter: (value, record) => record.asigned_to === value,
          sorter: (a, b) => a.asigned_to.localeCompare(b.asigned_to),
        },
        {
            title: 'Due Date',
            dataIndex: 'due_date',
